...
export const GALLERY_ITEMS = [
  {
    ...
    sub: "Kajiado County, 2025",
    bg: "linear-gradient(135deg,#0a3d62,#1a6fa8)",
    img: "/images/gallery/water-pan-3.jpeg", // ← paste your photo URL here
  },
  {
    id: 2, cat: "excavation",
    icon: "🚜", label: "Excavation",
    caption: "Precision Excavation Works",
    sub: "Makueni County, 2025",
  ...
  },
  {
    ...
    img: "/images/gallery/excavation-2.jpeg",
  },
  {
    id: 4, cat: "fencing",
    icon: "🚧", label: "Fencing",
    caption: "Water Pan Security Fencing",
    sub: "Nakuru County, 2024",
