...
export const GALLERY_ITEMS = [
  { id: 1, cat: "waterpan",   icon: "🏞️", label: "HDPE Water Pan",    caption: "Large HDPE Lined Water Pan",           sub: "Kajiado County, 2025",  bg: "linear-gradient(135deg,#0a3d62,#1a6fa8)" },
  { id: 2, cat: "excavation", icon: "🚜", label: "Excavation",         caption: "Precision Excavation Works",           sub: "Makueni County, 2025",  bg: "linear-gradient(135deg,#5d4037,#795548)" },
  { id: 3, cat: "waterpan",   icon: "🔵", label: "HDPE Lining",        caption: "HDPE Dam Liner Installation",          sub: "Laikipia, 2025",         bg: "linear-gradient(135deg,#1a237e,#283593)" },
  { id: 4, cat: "fencing",    icon: "🚧", label: "Fencing",            caption: "Water Pan Security Fencing",           sub: "Nakuru County, 2024",   bg: "linear-gradient(135deg,#33691e,#558b2f)" },
  { id: 5, cat: "farm",       icon: "🌾", label: "Farm Irrigation",    caption: "Farm Irrigation from Water Pan",        sub: "Taita Taveta, 2025",    bg: "linear-gradient(135deg,#2e7d32,#388e3c)" },
  { id: 6, cat: "waterpan",   icon: "💧", label: "Completed Pan",      caption: "Completed Water Pan — Full Capacity",  sub: "Baringo County, 2025",  bg: "linear-gradient(135deg,#004d40,#00695c)" },
  { id: 7, cat: "farm",       icon: "🐄", label: "Livestock Water",    caption: "Livestock Watering from Pan",          sub: "Samburu, 2024",          bg: "linear-gradient(135deg,#e65100,#f57c00)" },
  { id: 8, cat: "excavation", icon: "⛏️", label: "Site Prep",          caption: "Site Assessment & Preparation",        sub: "Kwale County, 2025",    bg: "linear-gradient(135deg,#37474f,#546e7a)" },
  { id: 9, cat: "waterpan",   icon: "🌅", label: "Before & After",     caption: "Water Pan Transformation",             sub: "Isiolo County, 2024",   bg: "linear-gradient(135deg,#006064,#00838f)" },
];
...
export const TRUST_BADGES = ["✅ Experienced Team","🧱 Quality Materials","🎯 Professional Service","🌍 Lasting Impact","🇰🇪 Proudly Kenyan"];